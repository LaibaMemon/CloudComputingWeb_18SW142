...
# Config Function 
st.set_page_config(page_title='Cloud Computing Project', page_icon='☁', layout='wide', initial_sidebar_state='auto')
...
with st.sidebar:
    selected = option_menu(
        menu_title='Laiba Memon (18SW142)',
...
if selected == 'Introduction':
    ...
    st.markdown('''
    #### **This is the project based on cloud computing, deploying an Tourist Predicition Web project on cloud**.
...
if selected == 'Dataset':
    ...
    st.markdown('---')
    st.markdown('### **Select the options to see the data detail**')
